...
public class DiagnosticMessages {
    ...
    // Deployment Diagnostic Report Messages
    ...
    public static final String PROBLEMSUMMARY_MULTIPLE_REVISION_SAME_BASEPATH = "Multiple Revisions deployed";
    ...
    public static final String RESOLUTION_UNDEPLOY_UNWANTED_REVISION = "Use Management API and undeploy the old/unwanted revision(s)";
}
